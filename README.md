...
| 04 | [OT-Thread Failure: exit(1) Without Cleanup — Persisted MAC Key (Delta) Reused After Restart](MP-SPDZ/MP-SPDZ-04-OT-Failure-State-Reuse.md) | CWE-459 / CWE-404 | High |
